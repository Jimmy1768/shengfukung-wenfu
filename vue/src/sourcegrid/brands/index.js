import hotelSuite from '@/assets/media/hotel/hotel_suite_golden.webp';
import hotelCourtyard from '@/assets/media/hotel/hotel_courtyard_evening.webp';
import hotelPool from '@/assets/media/hotel/hotel_pool_twilight.webp';
import hotelLobby from '@/assets/media/hotel/hotel_lobby_natural.webp';
import hotelBreakfast from '@/assets/media/hotel/hotel_breakfast_tray.webp';
import hotelSpa from '@/assets/media/hotel/hotel_spa_terrace.webp';
import hotelBalcony from '@/assets/media/hotel/hotel_balcony_sunrise.webp';
import hotelExterior from '@/assets/media/hotel/hotel_exterior_corner.webp';
import hotelDetail from '@/assets/media/hotel/hotel_detail_ceramic.webp';
import hotelTextureSand from '@/assets/media/hotel/hotel_gradient_sand.webp';
import hotelTextureLinen from '@/assets/media/hotel/hotel_texture_linen.webp';
import hotelTexturePool from '@/assets/media/hotel/hotel_texture_pool.webp';
import hotelTowels from '@/assets/media/hotel/hotel_towels_spa.webp';

import ramenHero from '@/assets/media/ramen/ramen_dining_area_glow.webp';
import ramenInterior from '@/assets/media/ramen/ramen_interior_minimal.webp';
import ramenBowlSteam from '@/assets/media/ramen/ramen_bowl_steam_close.webp';
import ramenBowlQuiet from '@/assets/media/ramen/ramen_bowl_quiet_luxury.webp';
import ramenBowlCeramic from '@/assets/media/ramen/ramen_bowl_ceramic_detail.webp';
import ramenBrothPour from '@/assets/media/ramen/ramen_broth_pour.webp';
import ramenChashu from '@/assets/media/ramen/ramen_chashu_close.webp';
import ramenChefFinishing from '@/assets/media/ramen/ramen_chef_finishing.webp';
import ramenChefService from '@/assets/media/ramen/ramen_chef_service.webp';
import ramenAjitama from '@/assets/media/ramen/ramen_ajitama_close.webp';
import ramenIngredients from '@/assets/media/ramen/ramen_ingredients_flatlay.webp';
import ramenToppings from '@/assets/media/ramen/ramen_toppings_overhead.webp';
import ramenTextureWood from '@/assets/media/ramen/ramen_texture_warm_wood.webp';
import ramenTextureSoft from '@/assets/media/ramen/ramen_texture_soft_linen.webp';
import ramenTextureCeramic from '@/assets/media/ramen/ramen_texture_ceramic_glaze.webp';

import clothingHero from '@/assets/media/clothing/clothing_model_backlit.webp';
import clothingStudio from '@/assets/media/clothing/clothing_model_studio.webp';
import clothingStoreInterior from '@/assets/media/clothing/clothing_store_interior.webp';
import clothingFittingArea from '@/assets/media/clothing/clothing_fitting_area.webp';
import clothingFlatlay from '@/assets/media/clothing/clothing_flatlay_neutral.webp';
import clothingAccessoryDisplay from '@/assets/media/clothing/clothing_accessory_display.webp';
import clothingSleeveAdjust from '@/assets/media/clothing/clothing_model_sleeve_adjust.webp';
import clothingSheerMotion from '@/assets/media/clothing/clothing_model_sheer_motion.webp';
import clothingFoldedStack from '@/assets/media/clothing/clothing_folded_stack.webp';
import clothingGradient from '@/assets/media/clothing/clothing_gradient_soft_beige.webp';
import clothingTextureLinen from '@/assets/media/clothing/clothing_texture_cream_linen.webp';
import clothingTextureStone from '@/assets/media/clothing/clothing_texture_matte_stone.webp';
import clothingTextureWoven from '@/assets/media/clothing/clothing_texture_woven_detail.webp';
import clothingMannequin from '@/assets/media/clothing/clothing_mannequin_close.webp';

import bistroAtmosphereShadowGradient from '@/assets/media/restaurant/bistro_atmosphere_shadow_gradient.webp';
import bistroDetailCandleSmoke from '@/assets/media/restaurant/bistro_detail_candle_smoke.webp';
import bistroDetailCutlery from '@/assets/media/restaurant/bistro_detail_cutlery.webp';
import bistroDetailGlassReflection from '@/assets/media/restaurant/bistro_detail_glass_reflection.webp';
import bistroDetailLinen from '@/assets/media/restaurant/bistro_detail_linen.webp';
import bistroDetailMenuPaper from '@/assets/media/restaurant/bistro_detail_menu_paper.webp';
import bistroDetailWoodSurface from '@/assets/media/restaurant/bistro_detail_wood_surface.webp';
import bistroFeatureBarSurface from '@/assets/media/restaurant/bistro_feature_bar_surface.webp';
import bistroFeatureCornerBooth from '@/assets/media/restaurant/bistro_feature_corner_booth.webp';
import bistroFeatureKitchenPass from '@/assets/media/restaurant/bistro_feature_kitchen_pass.webp';
import bistroFeatureTableSetting from '@/assets/media/restaurant/bistro_feature_table_setting.webp';
import bistroFeatureWineService from '@/assets/media/restaurant/bistro_feature_wine_service.webp';
import bistroHeroBarRitual from '@/assets/media/restaurant/bistro_hero_bar_ritual.webp';
import bistroHeroDiningNoir from '@/assets/media/restaurant/bistro_hero_dining_noir.webp';
import bistroHeroExteriorNight from '@/assets/media/restaurant/bistro_hero_exterior_night.webp';
