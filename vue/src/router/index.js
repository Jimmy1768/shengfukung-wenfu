...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'events', name: 'events', component: Events, meta: { title: '法會供品' } },
      { path: 'events/:slug', name: 'event', component: EventShow, meta: { title: '法會供品詳情' } },
      { path: 'archive', name: 'archive', component: Archive, meta: { title: '法會供品回顧' } },
      { path: 'news', name: 'news', component: News, meta: { title: '最新消息' } },
      { path: 'services', name: 'services', component: Services, meta: { title: '祈福供品' } },
