...
module Admin
  class EventsController < BaseController
    ...
    def index
      @offerings = current_temple.temple_events.order(created_at: :desc)
    end
    ...
    def create
      @offering = current_temple.temple_events.new(offering_params)
      apply_template_defaults(@offering, selected_template_slug, :events)
    ...
    def set_event
      @offering = current_temple.temple_events.find(params[:id])
    end
